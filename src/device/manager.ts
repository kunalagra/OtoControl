 ...
 * (see the `as const satisfies` on those constants in `driver.ts`) rather
...
export type ActiveDevice =
  | { id: typeof SENNHEISER_DRIVER.id; driver: typeof SENNHEISER_DRIVER; device: MomentumDevice; state: DeviceState }
  | { id: typeof SONY_DRIVER.id; driver: typeof SONY_DRIVER; device: SonyDevice; state: SonyState };
